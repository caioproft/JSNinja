(function() {
  ...
  let fullName = "caio-silveira-fermiano-de-proft";
  ...
  let names = ["Ariane", "Mateus", "Felipe", "Mauricio", "Rafael", "Vitor"];
  let result = names.reduce(function(acumulado, atual, index) {
