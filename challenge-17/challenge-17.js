(function() {
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, "Caio Proft"));
  ...
  console.log(text.replace(/brasileiro/, "araraquarense"));
  ...
  console.log(
    `O mês de setembro é representado pelo número ${getMonthNumber("stembro")}`
  );
  console.log(
